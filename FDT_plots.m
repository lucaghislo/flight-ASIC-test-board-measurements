...
% data acquisition
T_30A = readtable('MODULE_003/TransferFunction30A.dat', 'VariableNamingRule','preserve'); % change to MODULE_003
T_20A = readtable('MODULE_003/TransferFunction20A.dat', 'VariableNamingRule','preserve'); % change to MODULE_003
T_10A = readtable('MODULE_003/TransferFunction10A.dat', 'VariableNamingRule','preserve'); % change to MODULE_003
T_0A = readtable('MODULE_003/TransferFunction0A.dat', 'VariableNamingRule','preserve'); % change to MODULE_003
T_m10A = readtable('MODULE_003/TransferFunction-10A.dat', 'VariableNamingRule','preserve'); % change to MODULE_003
T_m20A = readtable('MODULE_003/TransferFunction-20A.dat', 'VariableNamingRule','preserve'); % change to MODULE_003
T_m30A = readtable('MODULE_003/TransferFunction-30A.dat', 'VariableNamingRule','preserve'); % change to MODULE_003
T_m32A = readtable('MODULE_002/TransferFunction-32A.dat', 'VariableNamingRule','preserve');
T_m34A = readtable('MODULE_002/TransferFunction-34A.dat', 'VariableNamingRule','preserve');
T_m36A = readtable('MODULE_002/TransferFunction-36A.dat', 'VariableNamingRule','preserve');
T_m38A = readtable('MODULE_002/TransferFunction-38A.dat', 'VariableNamingRule','preserve');
T_m40A = readtable('MODULE_003/TransferFunction-40A.dat', 'VariableNamingRule','preserve'); % change to MODULE_003

T_30B = readtable('MODULE_003/TransferFunction30B.dat', 'VariableNamingRule','preserve'); % change to MODULE_003
T_20B = readtable('MODULE_003/TransferFunction20B.dat', 'VariableNamingRule','preserve'); % change to MODULE_003
T_10B = readtable('MODULE_003/TransferFunction10B.dat', 'VariableNamingRule','preserve'); % change to MODULE_003
T_0B = readtable('MODULE_003/TransferFunction0B.dat', 'VariableNamingRule','preserve'); % change to MODULE_003
T_m10B = readtable('MODULE_003/TransferFunction-10B.dat', 'VariableNamingRule','preserve'); % change to MODULE_003
T_m20B = readtable('MODULE_003/TransferFunction-20B.dat', 'VariableNamingRule','preserve'); % change to MODULE_003
T_m30B = readtable('MODULE_003/TransferFunction-30B.dat', 'VariableNamingRule','preserve'); % change to MODULE_003
T_m32B = readtable('MODULE_002/TransferFunction-32B.dat', 'VariableNamingRule','preserve');
T_m34B = readtable('MODULE_002/TransferFunction-34B.dat', 'VariableNamingRule','preserve');
T_m36B = readtable('MODULE_002/TransferFunction-36B.dat', 'VariableNamingRule','preserve');
T_m38B = readtable('MODULE_002/TransferFunction-38B.dat', 'VariableNamingRule','preserve');
T_m40B = readtable('MODULE_003/TransferFunction-40B.dat', 'VariableNamingRule','preserve'); % change to MODULE_003
...
%% errorbar plot TDF CSAVrefGM: auto [X axis: DAC code]
...
hold on;
%errorbar(X(1:55), T_tab_m32A_mean, T_tab_m32A_std)
hold on;
%errorbar(X(1:55), T_tab_m34A_mean, T_tab_m34A_std)
hold on;
%errorbar(X(1:55), T_tab_m36A_mean, T_tab_m36A_std)
hold on;
%errorbar(X(1:55), T_tab_m38A_mean, T_tab_m38A_std)
hold on;
errorbar(X(1:55), T_tab_m40A_mean, T_tab_m40A_std)

title(['Transfer Function for \tau_{' num2str(tau) '}: CSAVrefGM auto']);
...
savefig(sprintf('fig/errbar_fdt_csavrefgm_auto_tau%d_DAC.fig', tau))
exportgraphics(gcf, sprintf('pdf/errbar_fdt_csavrefgm_auto_tau%d_DAC.pdf', tau),'ContentType','vector');


%% simple line plot TDF CSAVrefGM: auto [X axis: DAC code]
...
xlim([0, 64000]);
legend('T = 30°C', 'T = 20°C', 'T = 10°C', 'T = 0°C', 'T = -10°C', 'T = -20°C', 'T = -30°C', 'T = -40°C', 'Location','southeast')
savefig('fig/fdt_csavrefgm_auto_tau6_DAC.fig')
exportgraphics(gcf,'pdf/fdt_csavrefgm_auto_tau6_DAC.pdf','ContentType','vector');
...
%% errorbar plot TDF CSAVrefGM: auto [X axis: keV]
...
xlim([0, 53824]);
legend('T = 30°C', 'T = 20°C', 'T = 10°C', 'T = 0°C', 'T = -10°C', 'T = -20°C', 'T = -30°C', 'T = -40°C', 'Location','southeast')
savefig('fig/errbar_fdt_csavrefgm_auto_tau6_keV.fig')
exportgraphics(gcf,'pdf/errbar_fdt_csavrefgm_auto_tau6_keV.pdf','ContentType','vector');


%% simple line plot TDF CSAVrefGM: auto [X axis: keV]
...
xlim([0, 53824]);
legend('T = 30°C', 'T = 20°C', 'T = 10°C', 'T = 0°C', 'T = -10°C', 'T = -20°C', 'T = -30°C', 'T = -40°C', 'Location','southeast')
savefig('fig/fdt_csavrefgm_auto_tau6_keV.fig')
exportgraphics(gcf,'pdf/fdt_csavrefgm_auto_tau6_keV.pdf','ContentType','vector');
...
%% simple line plot TDF CSAVrefGM: auto [X axis: DAC code] [-40°C to -30°C]
...
savefig('fig/fdt_csavrefgm_auto_tau6_DAC_40-30.fig')
exportgraphics(gcf,'pdf/fdt_csavrefgm_auto_tau6_DAC_40-30.pdf','ContentType','vector');
...
%% simple line plot TDF CSAVrefGM: auto & 530mV [X axis: DAC code] [-40°C to 30°C, 10°C/step]
...
savefig('fig/fdt_csavrefgm_auto-530mV_tau6_DAC.fig')
exportgraphics(gcf,'pdf/fdt_csavrefgm_auto-530mV_tau6_DAC.pdf','ContentType','vector');


%% simple line plot TDF CSAVrefGM: auto & 530mV [X axis: DAC code] [-40°C to -30°C, 2°C/step]
...
savefig('fig/fdt_csavrefgm_auto-530mV_tau6_DAC_40-30.fig')
exportgraphics(gcf,'pdf/fdt_csavrefgm_auto-530mV_tau6_DAC_40-30.pdf','ContentType','vector');


%% simple line plot TDF CSAVrefGM: auto [X axis: keV] [-40°C to -30°C]
...
xlim([0, 53824]);
legend('T = -30°C', 'T = -32°C', 'T = -34°C', 'T = -36°C', 'T = -38°C', 'T = -40°C', 'Location','southeast')
savefig('fig/fdt_csavrefgm_auto_tau6_keV_40-30.fig')
exportgraphics(gcf,'pdf/fdt_csavrefgm_auto_tau6_DAC_40-30.pdf','ContentType','vector');

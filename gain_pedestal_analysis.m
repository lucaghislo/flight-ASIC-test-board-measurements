...
savefig('fig/high_energy_gain_530mv.fig')
exportgraphics(gcf, 'pdf/high_energy_gain_530mv.pdf','ContentType','vector');
hold off
...
savefig('fig/high_energy_pedestal_530mv.fig')
exportgraphics(gcf, 'pdf/high_energy_pedestal_530mv.pdf','ContentType','vector');
hold off